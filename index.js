...
function displayItems(){
    ...
    var nippet=  document.getElementById('nippet');;
    var meer=  document.getElementById('meer');
    var veggi=  document.getElementById('veggi');


    const senatorData= foodItem.filter((item)=>item.category=='senator');
    const meerData= foodItem.filter((item)=>item.category=='meer');
    const nippetData= foodItem.filter((item)=>item.category=='nippet');
    const veggiData= foodItem.filter((item)=>item.category=='veggi');
   

    senatorData.map(item=>{
